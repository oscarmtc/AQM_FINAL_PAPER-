...
variables_re_T2  <- c("female",                 # IV  ...  NOTE: IV > Independent Variable  
                      "age",                    # IV
                      "edu3_2",                 # IV
                      "edu3_3",                 # IV
                      "dhincome_all",           # IV
...
variables_re_T3  <- c("female",                 # IV  ...  NOTE: IV > Independent Variable  
                      "age",                    # IV
                      "edu3_2",                 # IV
                      "edu3_3",                 # IV
                      "dhincome_all",           # IV
...
data_panel3 <- na.omit(data_panel[, c(variables_re_T3, "vim_vox")])
...
# ... as above, we create a subset of the data frame "data_panel3" containing only observations for which the value of "year" is 2020 ...
rep_m2_T2 <- subset(data_panel3,year == 2020) 
...
# ... and proceed to define the set of independent variables (we use the same vector as for model 1, but only modify its name) ...
independent_variables_rm2_T2  <- independent_variables_rm1_T2
...
##Analysis Part 3: Replication and Reproduction of the Paper's Original Results
