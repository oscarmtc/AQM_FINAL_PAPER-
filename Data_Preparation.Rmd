...
library(readr)
data_rep_T3 <- fread("data_table_3.csv")
...
# .............................................................................#
# ...................... Joint Display MODELS 1, 2, 3 & 4 .....................#
# .............................................................................#

output_1 <- cbind(point_estimates_rm1_T4, SE_rm1_T4)
colnames(output_1) <- c('Coefficients - 2019', 'SE')
rownames(output_1) <-  c("Intercept",
                         "Female",
                         "Age",
...
output_2 <- cbind(point_estimates_rm2_T4, SE_rm2_T4)
colnames(output_2) <- c('Coefficients - 2020', 'SE')
rownames(output_2) <-  c("Intercept",
                         "Female",
                         "Age",
...
output_3 <- cbind(point_estimates_rm3_T4, SE_rm3_T4)
colnames(output_3) <- c('Coefficients - 2019', 'SE')
...
output_4 <- cbind(point_estimates_rm4_T4, SE_rm4_T4)
colnames(output_4) <- c('Coefficients - 2020', 'SE')
rownames(output_4) <-  c("Intercept",
                         "Female",
                         "Age",
                         "High school / Vocational",
                         "College",
...
unified_table <- cbind(output_1, output_2, output_3, output_4)

kable(unified_table,  digits = 3, align = "ccrl",
      booktabs = T,
      caption = " Effect of Prior Change in Attitudes and Vote Intention on Intended Vote for Vox") %>%
  kable_styling(full_width = FALSE)
...
t3m1 <- glm(vim_vox ~ female + age + edu3_2 + edu3_3 + dhincome_all + livingpartner + intpol + l2vim_vox + l2authoritarian + l2ideol + l2nativism + l2orgterr + l2pop6amz + l2msexism + lsvim_vox + lsauthoritarian + lsideol + lsnativism + lsorgterr + lspop6amz + lsmsexism, family = binomial(logit), method = "brglmFit",  data = data_rep_T3 %>% filter(year == 2019))


## Column 2 (model 2, 2020)
t3m2 <- glm(vim_vox ~ female + age + edu3_2 + edu3_3 + dhincome_all + livingpartner + intpol + l2vim_vox + l2authoritarian + l2ideol + l2nativism + l2orgterr + l2pop6amz + l2msexism + lsvim_vox + lsauthoritarian + lsideol + lsnativism + lsorgterr + lspop6amz + lsmsexism, family = binomial(logit), method = "brglmFit", data = data_rep_T3 %>% filter(year == 2020))
