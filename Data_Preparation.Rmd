...
# ... we then generate the variables 'vr16_17a' and 'vr16_18a' variables by taking the maximum for value of "vr16_17" and "vr16_18", respectively, for each respondent

data_panel$vr16_17a <- ave(data_panel$vr16_17, data_panel$idcode, FUN = max)
...
data_panel$vr16_18a <- ave(data_panel$vr16_18, data_panel$idcode, FUN = max)
mean(data_panel$vr16_18a) # CHECK: same descriptive statistics as STATA output
