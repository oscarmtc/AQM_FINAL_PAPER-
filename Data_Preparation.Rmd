...
par(mfrow = c(6, 1)) # This will allow us to display the predicted probabilities for the two models side by side ...
...
polygon(c(lsmsexism_seq_m12E2v, rev(lsmsexism_seq_m12E2)), c(upper_men_m1E2, rev(lower_men_m1E2)), col = rgb(0, 0, 1, 0.2), border = NA)

# Predicted probabilities for treatment and control group
lines(x = sexism_seq_m1E2, y = apply(sim_women_m1E2, 2, mean), lwd = 2, col = "red")
lines(x = sexism_seq_m1E2, y = apply(sim_men_m1E2, 2, mean), lwd = 2, col = "blue")
...
# ... and add confidence intervals as shaded areas ...
polygon(c(sexism_seq_m1E2, rev(sexism_seq_m1E2)), c(upper_women_m1E2, rev(lower_women_m1E2)), col = rgb(1, 0, 0, 0.2), border = NA)
polygon(c(sexism_seq_m1E2, rev(sexism_seq_m1E2)), c(upper_men_m1E2, rev(lower_men_m1E2)), col = rgb(0, 0, 1, 0.2), border = NA)
...
#_____________________________________________________________________________#
# ... the following command lines save the generated plots into a single PDF-file ...
dev.copy2pdf(file = ("Predicted_Probabilities_E2.pdf"), 
             family = "Times", 
             width = 12, 
             height=6)
#_____________________________________________________________________________#
