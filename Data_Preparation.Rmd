...
# ... we proceed to generate 'vr16_17a' and 'vr16_18a' variables by taking the maximum for value of "vr16_17" and "vr16_18" for each respondent ... 
data_panel <- data_panel %>%
  group_by(idcode) %>%
...
# ... we first generate the 'v16all' variable based with the same values as "vr16_17a" ...
data_panel$v16all <- data_panel$vr16_17a

# ... we the replace values in "v16all" with values from "vr16_18a" based on conditions ...
...
data_panel$v16all_labels <- factor(data_panel$v16all, labels = c("Others", "PSOE", "PP", "Podemos", "Ciudadanos")) 
summary(data_panel$v16all_labels) # CHECK: same descriptive statistics as STATA output
